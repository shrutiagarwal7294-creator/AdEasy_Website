...
Static marketing website for AdsEasy Media, an AI-first digital marketing agency. 47 pages of pure HTML/CSS/JS — **no build step, no framework, no dependencies**.
